...
import com.example.mysamplemvvmarchapp.NoteAdapter;
import com.example.mysamplemvvmarchapp.R;
import com.example.mysamplemvvmarchapp.repository.room.roomdatabase.Note;
import com.example.mysamplemvvmarchapp.viewmodel.NoteViewModel;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.deleteAll:
                ...
                Toast.makeText(MainActivity.this, "Deleted all notes", Toast.LENGTH_LONG).show();
                return true;
            case R.id.showmap:
                showLocation();
                return true;
